...
def random_forest(all_year=False, winter=False):
    ...
    # Confusion Matrices
    cm_validation_image_path = f"{IMAGE_FOLDER}/rf_confusion_matrix_validation_{season_name_file}.png"
    cm_test_image_path = f"{IMAGE_FOLDER}/rf_confusion_matrix_test_{season_name_file}.png"
    # Several Metrics
    val_report_path = f"{REPORT_FOLDER}/rf_validation_classification_report_{season_name_file}.csv"
    test_report_path = f"{REPORT_FOLDER}/rf_test_classification_report_{season_name_file}.csv"
    combined_acc_path = f"{REPORT_FOLDER}/rf_class_accuracies_{season_name_file}.csv"
    val_class_acc_image_path = f"{IMAGE_FOLDER}/rf_val_class_accuracy_{season_name_file}.png"
    test_class_acc_image_path = f"{IMAGE_FOLDER}/rf_test_class_accuracy_{season_name_file}.png"
    # Top Features
    top_features_file_path = f"{REPORT_FOLDER}/rf_top_{TOP_FEATURES}_features_{season_name_file}.csv"
    top_features_image_path = f"{IMAGE_FOLDER}/rf_feature_importance_{TOP_FEATURES}_{season_name_file}.png"
    # Metrics Reports
    cv_metrics_path = f"{REPORT_FOLDER}/rf_cross_validation_raw_scores_{season_name_file}.csv"
    summary_metrics_path = f"{REPORT_FOLDER}/rf_cross_validation_summary_{season_name_file}.csv"
    # AUC and FP-TP Plots
    auc_val_image_path = f"{IMAGE_FOLDER}/rf_auc_val_precision_vs_recall_{season_name_file}.png"
    auc_test_image_path = f"{IMAGE_FOLDER}/rf_auc_test_precision_vs_recall_{season_name_file}.png"
